...
import com.example.errormessage.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun emailFocusListener() {
        binding.emailEditText.setOnFocusChangeListener{view , focused ->
            if(!focused){
                binding.emailContainer.helperText = validEmail()
            }
        }
    ...
    private fun passwordFocusListener() {
        binding.passwordEditText.setOnFocusChangeListener { view, focused ->
            if(!focused){
                binding.passwordContainer.helperText = validPassword()
            }
        }
    ...
    private fun phoneFocusListener(){
        binding.phoneEditText.setOnFocusChangeListener { view, focused ->
            if(!focused){
                binding.phoneContainer.helperText = validPhone()
            }
        }
